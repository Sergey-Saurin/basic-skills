...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        inputErrorsLogger = LogManager.getLogger("InputErrors");
        ...
        try {
            for(;;)
            {
                //Ошибка для проверки записи лога
                //double i = 1 + Double.parseDouble("eee");
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            inputErrorsLogger.warn("Станция не найдена: " + line);
        }
    }
